...
vip = function() {
	return {
		...
		$.each(response.locations, function(i,item){ // Parse out the address of the polling location.
	    ...
	    mapSize : function() { // Sets the map to 100% height, then subtracts the size of the page header. Called on window resize/orientation change.
